<template>
    <div>
        ...
        <h3 class="text-xl font-bold mt-6">👨‍⚕️ Agent (Personne)</h3>
        <table class="min-w-full border-collapse border border-gray-300 mt-2">
            ...
            <tr v-for="zone in paginatedZonesPersonne" :key="zone.id">
                <td class="border border-gray-300 px-4 py-2">{{ zone.id }}</td>
        ...
        <!-- Pagination pour les zones de type "personne" -->
        ...
        <h3 class="text-xl font-bold mt-6">📍Lieu (Zone)</h3>
        <table class="min-w-full border-collapse border border-gray-300 mt-2">
            <thead>
            <tr>
                <th class="border border-gray-300 px-4 py-2">ID</th>
...
export default {
    ...
    computed: {
        // Zones de type "personne" avec pagination
