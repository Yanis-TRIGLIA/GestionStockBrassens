            ...
            <div class="p-6 pt-0">
                ...
                <form @submit.prevent="validateForm">
                    ...
                    <div class="mb-4">
                        ...
                        <select required id="zone" v-model="selectedZone" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div class="mb-4">
                        <label for="person" class="block text-gray-600 font-medium mb-2">Sélectionnez la personne responsable</label>
                        <select required id="person" v-model="selectedPerson" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            <option value="">Sélectionnez une personne</option>
                            <option v-for="person in allPersons" :key="person.id" :value="person.id">{{ person.nom }}</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="observation" v-model="observation" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
